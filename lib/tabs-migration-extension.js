...
module.exports.register = function ({ config = {} }) {
  this.once('contentClassified', ({ playbook, contentCatalog }) => {
    ...
    const { saveResult, unwrapExampleBlock = 'tabs', tabsDelimiterLength = 6, normalize } = config
      console.log(`tabs-migration-extension saveResult = ${saveResult} unwrapExampleBlock = ${unwrapExampleBlock} tabsDelimiterLength = ${tabsDelimiterLength} normalize = ${normalize}`)
    ...
    console.log(`filesToMigrate ${filesToMigrate.length} ${filesToMigrate}`)
